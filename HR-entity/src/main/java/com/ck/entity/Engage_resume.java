...
public class Engage_resume {
    ...
    public Engage_resume(int res_id, String human_name, String engage_type, String human_address, int human_postcode, int human_major_kind_id, String human_major_kind_name, int human_major_id, String human_major_name, String human_telephone, String human_homephone, String human_mobilephone, String human_email, String human_hobby, String human_specility, String human_sex, String human_religion, String human_party, String human_nationality, String human_race, String human_birthday, int human_age, String human_educated_degree, double human_educated_years, String human_educated_major, String human_college, String human_idcard, String human_birthplace, String demand_salary_standard, String human_history_records, String remark, String recomandation, String human_picture, String attachment_name, int check_status, String register, String regist_time, String checker, String check_time, int interview_status, double total_points, int test_amount, String test_checker, String test_check_time, String pass_register, String pass_regist_time, String pass_checker, String pass_check_time, int pass_check_status, String pass_checkComment, String pass_passComment) {
        this.res_id = res_id;
